# Contributing to create-rails-app
...
- Include the create-rails-app version, Ruby version, and OS
...
Open a [GitHub issue](https://github.com/svyatov/create-rails-app/issues) for questions or discussion.
